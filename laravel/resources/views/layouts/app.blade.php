            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li class="user-body">
                <div class="row no-gutters">
                  ...
                  <div class="col-12 text-left">
                    <a href="#"><i class="ion ion-email-unread"></i> Mensajes</a>
                  </div>
                  <div class="col-12 text-left">
                    <a href="#"><i class="ion ion-settings"></i> Configuracion</a>
                  </div>
				<div role="separator" class="divider col-12"></div>
				  <div class="col-12 text-left">
                    <a href="#"><i class="ti-settings"></i> Configuracion de Cuenta</a>
                  </div>
				<div role="separator" class="divider col-12"></div>
				  <div class="col-12 text-left">
                    <a href="{{ route('logout') }}"
...
<!--			 <a href="index.html">
        ...
        <div class="info">
          <p>{{ Auth::user()->name }}</p>
			<a href="./profile.html" class="link" data-toggle="tooltip" title="" data-original-title="Settings"><i class="ion ion-gear-b"></i></a>
            <a href="./profile.html" class="link" data-toggle="tooltip" title="" data-original-title="Email"><i class="ion ion-android-mail"></i></a>
            <a href="{{ route('logout') }}"
            onclick="event.preventDefault();
