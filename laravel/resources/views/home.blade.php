            ...
            <ul class="timeline">
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    ...
                    <h3 class="timeline-header no-border"><a href="#">Don Roy</a> accepted your friend request</h3>
                  </div>
                </li>
                <!-- END timeline item -->
                <!-- timeline item -->
                  ...
                  <div class="timeline-item">
                    ...
                    <div class="timeline-body">
                      <div class="embed-responsive embed-responsive-16by9">
                        <iframe width="854" height="480" src="https://www.youtube.com/embed/k85mRPqvMbE" class="b-0" allowfullscreen=""></iframe>
                      </div>
                    </div>
                    <div class="timeline-footer text-right">
